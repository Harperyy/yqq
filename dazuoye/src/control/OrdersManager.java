...
public class OrdersManager {
    ...
    public List<BeanOrder> loadX() throws BaseException{
        Connection conn = null;
        List<BeanOrder> re = new ArrayList<>();
        try{
            conn = DBUtil.getConnection();
            String sql;
            java.sql.PreparedStatement pst;
            sql = "select * from orders o1,orderdetail o2,fresh f where  o1.ord_id=o2.ord_id and o2.fre_id=f.fre_id  and o1.ord_state=? ";
            pst = conn.prepareStatement(sql);
    ...
    public List<BeanOrder> loadP() throws BaseException{
        Connection conn = null;
        List<BeanOrder> re = new ArrayList<>();
        try{
            conn = DBUtil.getConnection();
    ...
    public List<BeanOrder> loadT() throws BaseException{
        Connection conn = null;
        List<BeanOrder> re = new ArrayList<>();
        try{
            conn = DBUtil.getConnection();
    ...
    public void UpX(int id) throws BaseException{
        ...
        try{
            ...
            String sql;
            java.sql.PreparedStatement pst;
            sql = "update orders set ord_state= '配送' where ord_id=? ";
            pst = conn.prepareStatement(sql);
            pst.setInt(1,id);
            //pst.setString(2,"下单");
            pst.execute();
    ...
    public void UpP(int id) throws BaseException{
        ...
        try{
            ...
            String sql;
            java.sql.PreparedStatement pst;
            sql = "update orders set ord_state= '送达' where ord_id=?";
            pst = conn.prepareStatement(sql);
            pst.setInt(1,id);
            //pst.setString(2,"配送");
            pst.execute();
    ...
    public void UpS (int id) throws BaseException{
        ...
        try{
            ...
            String sql;
            java.sql.PreparedStatement pst;
            sql = "update orders set ord_state= '订单完成' where ord_id=?";
            pst = conn.prepareStatement(sql);
            pst.setInt(1,id);
           // pst.setString(2,"送达");
            pst.execute();
    ...
    public void UpS2 (int id) throws BaseException{
        ...
        try{
            ...
            String sql;
            java.sql.PreparedStatement pst;
            sql = "update orders set ord_state= '退货' where ord_id=?";
            pst = conn.prepareStatement(sql);
            pst.setInt(1,id);
            //pst.setString(2,"送达");
            pst.execute();
    ...
    public void UpT(int id) throws BaseException{
        ...
        try{
            ...
            String sql;
            java.sql.PreparedStatement pst;
            sql = "update orders set ord_state= '订单取消' where ord_id=? ";
            pst = conn.prepareStatement(sql);
            pst.setInt(1,id);
    ...
    public BeanOrdDetail loadDetail(int id) throws BaseException{
        ...
        try{
            ...
            if (rs.next()){
                ...
                b.setCou_dis(rs.getDouble(3)-rs.getDouble(4)-(1-rs.getDouble(14)/10)*rs.getDouble(3));
                b.setDisc_dis((1-rs.getDouble(14)/10)*rs.getDouble(3));
                rs.close();
                pst.close();
    ...
    public  int getMaxId()throws BaseException{
        Connection conn = null;
        int id;
        try{
            conn = DBUtil.getConnection();
